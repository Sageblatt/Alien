...
Player::Player(float sp_x, float sp_y, int wind_w, int wind_h, double health): JUMP_SPEED(sp_y) {
    ...
    sprite.setPosition((float)(window_width / 2.0), (float)(window_height - height * SCALE_Y));
...
void Player::move() {
    ...
    switch (direction_move)
    {
        ...
        case GO_RIGHT: // Right, 1; +
            ...
            if (sprite.getPosition().x <= (float)(window_width - width* SCALE_X))
        ...
        case JUMP_SEE_RIGHT: // Up, to See to Right, 3; +
            ...
            else if (sprite.getPosition().y < (float)(window_height - height * SCALE_Y) and -speed_y + g_accel * dt > 0) {
        ...
        case JUMP_RIGHT: // Up to Right, 4; +
            if (-speed_y + g_accel * dt < 0) {
                ...
                speed_y = speed_y - g_accel * dt;
                return;
            } else if (sprite.getPosition().y < (float)(window_height - height * SCALE_Y)
        ...
        case FIRE_RIGHT: // Shout to Right, 5; +
            ...
            if (Keyboard::isKeyPressed(Keyboard::Right) && onGround) {
                ...
                if (sprite.getPosition().y < (float)(window_height - height * SCALE_Y)) {
